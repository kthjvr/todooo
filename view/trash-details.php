...
$info_sql ="SELECT * FROM mytasks JOIN categories WHERE categories.categoryID=mytasks.categoryID AND categories.id=$id AND mytasks.id=$id AND taskID='$taskID' AND mytasks.trash='1' AND mytasks.currentStatus='Discarded'";
