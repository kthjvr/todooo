      ...
      <table id="myTable">
        ...
        <tbody id="table-body">
          <?php 
            ...
            $info_sql = "SELECT * FROM mytasks JOIN categories WHERE categories.categoryID=mytasks.categoryID AND categories.id=mytasks.id AND mytasks.trash='1' AND mytasks.currentStatus='Discarded'"; //retrieve info from db
      ...
      <form method="POST" action="../backend/submit.php">
        ...
        <div class="form_wrap form_grp">
          <div class="form_item">
            ...
            <option value="1">General Tasks</option>
            <?php
              $conn = mysqli_connect($servername, $username, $password, $dbname);  // Connect to the database again
              if (!$conn) { die("Connection failed: " . mysqli_connect_error()); } // Check connection again
