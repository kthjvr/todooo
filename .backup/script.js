...
today.addEventListener("click", (e) => {
  toggleMenu(today);
  window.location.href = "../view/tasks-today.php";
});

important.addEventListener("click", (e) => {
  toggleMenu(important);
  window.location.href = "../view/tasks-starred.php";
});

booklog.addEventListener("click", (e) => {
  toggleMenu(booklog);
  window.location.href = "../view/tasks-completed.php";
});
...
trash.addEventListener("click", (e) => {
  toggleMenu(trash);
  window.location.href = "../view/tasks-trash.php";
});

add.addEventListener("click", (e) => {
  toggleMenu(add);
  window.location.href = "../view/addTask.php";
});
