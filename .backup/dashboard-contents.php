...
<html>
    ...
    <body>
        <nav id="tabs" class='category-tab'>
            ...
            <!-- <a><span class="username">Hi,  <?=$_SESSION['username']?>!</span><img src="images/logo.png" alt="logo" class="logo"></a>
            <a class="pageLinks" ><i class="fa fa-calendar-check-o"></i><span>My Day</span></a>
            <a class="pageLinks" ><i class="fa fa-star"></i><span>Starred</span></a>
            <a class="pageLinks" ><i class="fa fa-folder-open"></i><span>All Tasks</span></a>
            <a class="pageLinks"  ><i class="fa fa-book"></i><span>Log Book</span></a>
            <a class="pageLinks" ><i class="fa fa-plus-square"></i><span>Add Task</span></a>
            <a href="index.html"><i class="fa fa-sign-out"></i><span>Sign Out</span></a> -->
        </nav>
              ...
              <div class="container-db">
                <div class="row">
                  <div class="col">
                    ...
                    <iframe src="view/tasks-extremepriority.php" id="pageFrame" class="db-prio"></iframe>
                    </div>
                    <div class="sub-container">
                    <iframe src="view/tasks-highpriority.php" id="pageFrame" class="db-prio"></iframe>
                    </div>
                  </div>
                  <div class="col">
                    <div class="sub-container">
                    <iframe src="view/tasks-mediumpriority.php" id="pageFrame" class="db-prio"></iframe>
                    </div>
                    <div class="sub-container">
                    <iframe src="view/tasks-lowpriority.php" id="pageFrame" class="db-prio"></iframe>
                    </div>
                  </div>
                </div>
              </div>
...
$(document).ready(function() {
  ...
  // const reloadLinks = document.querySelectorAll('.pageLinks');  
  // const myFrame = document.getElementById('pageFrame');
  ...
  // myFrame.addEventListener('click', function() {
  //   // Reload the frame when it finishes loading
  //   myFrame.contentWindow.location.reload();
  // });
