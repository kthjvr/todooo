...
if (isset($_SESSION['loggedin'])) {
    ...
    $sql = "UPDATE mytasks SET currentStatus='$currentStatus', taskName='$taskName', taskDescription='$taskDescription', endDate='$endDate', priority_stat='$priority_stat', starred='$starred', categoryID='$category', trash='0' WHERE taskID='$taskID'";
