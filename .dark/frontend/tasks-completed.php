      ...
      <table id="myTable">
        ...
        <tbody id="table-body">
          <?php 
            ...
            $info_sql = "SELECT * FROM mytasks JOIN categories WHERE categories.categoryID=mytasks.categoryID AND categories.id=mytasks.id AND mytasks.trash='0' AND mytasks.currentStatus='Completed'"; //retrieve info from db
